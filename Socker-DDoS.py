...
print(Fore.RED + "Code By Dinh Gia Quy Dev - 2022/19/11")
print(" ")
print("Version 1.0  https://github.com/giaquy208/Socker-DDoS.git\n") 

time.sleep(1)
print (Fore.BLUE+"> DINH GIA QUY ")
time.sleep(1)
print (Fore.BLUE+"> Current build: 1.0")
time.sleep(3)
print (Fore.GREEN+"> Coded by Dinh Gia Quy Dev")
time.sleep(2)
print (Fore.BLUE+"> Dinh Gia Quy Members:")
print (Fore.CYAN+">>>VH-TEAM DOS")
print (Fore.CYAN+">>>vungochan208")
print (Fore.CYAN+">>>Istana Kerajaan")
